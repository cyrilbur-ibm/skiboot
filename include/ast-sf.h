...
int ast_sf_open(uint8_t type, struct spi_flash_ctrl **ct);
int ast2400_sf_open(uint8_t type, struct spi_flash_ctrl **ct);
int ast2500_sf_open(uint8_t type, struct spi_flash_ctrl **ct);
